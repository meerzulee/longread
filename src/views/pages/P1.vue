<template>
  <div class="h-screen bg-blue-900 relative flex justify-center">
    ...
    /> -->
    <BgVideo
      src="https://walkerstory.com/assets/media/videos/mp4/1.mp4"
      class="object-right-bottom"
    />
    <!-- <video
      autoplay
    ...
    >
      <Header>
        <template v-slot:name>{{ $t('page1name') }}</template>
        {{ $t('page1desc') }}
      </Header>
      <Story :storyText="$t('page1storytext')" />
    </div>
  </div>
</template>
